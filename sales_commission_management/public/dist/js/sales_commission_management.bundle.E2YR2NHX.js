(()=>{frappe.templates.custom_crm_notes=`<div class="notes-section col-xs-12">
			...
			{% for(var i=0, l=notes.length; i<l; i++) { %}
				<div class="comment-content p-3 row" name="{{ notes[i].name }}">
					...
					<div class="content col-xs-2">
						{{ notes[i].custom_item_code }}
					</div>
					<div class="content col-xs-2">
						{{ notes[i].custom_description }}
					</div>
...
//# sourceMappingURL=sales_commission_management.bundle.E2YR2NHX.js.map
